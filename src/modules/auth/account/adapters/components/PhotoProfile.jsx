...
import UsuarioPhoto from '../../../../../../assets/img/avatar-de-usuario.png'
...
export default function PhotoProfile(props) {
  ...
  const uploadImage = async (uri) => {
    try {
      ...
      const blob = await response.blob();     //Convertir a Blob para trabajar
      const storage = getStorage();
  ...
  return (
    <View style={styles.row}>
      ...
      <Loading isShow={loading} title="Cambiando foto de perfil" setShow={setLoading} />
    </View>
  );
}
